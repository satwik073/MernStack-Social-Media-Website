...
const FollowersCard = ({handleClose}) => {
  ...
  return (
    <div className="header px-2">
      ...
      {/* <Logout /> */}
      <h1 className='text-xl textFlex mb-6'>People Following You</h1>
      <div className="FriendsList  max-h-[60vh] w-[60vh]  overflow-y-auto hideScroll ">
        <div className="followers-list">
          <ul>
            {followerUsernames.map((followerData, index) => (
                  <div className="flex items-center space-x-3  mb-4 p-2 w-full" onClick={()=>handleUserClick(followerData._id)}>
              <li key={index}>
                <div className="flex items-center space-x-3 mb-3 ">
                  <img src={followerData.avatar} className="rounded-full h-11 w-11 object-cover" alt="" />
                  <div>
                    <p className=' text-xs textFlex'>@{followerData.username}</p>
