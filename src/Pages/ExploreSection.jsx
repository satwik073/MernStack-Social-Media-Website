...
const ExploreSection= () => {
  ...
  return (
    ...
    <div className="container mt-8 max-h-[90vh] overflow-y-auto hideScroll">
      <h1 className="text-xl textFlex font-bold mb-6">All Posts</h1>
      <div className="p-3 pt-0 grid lg:grid-cols-3 md:grid-cols-2 grid-cols-1">
        {posts.map((post) => {
          ...
          return (
            <div key={post._id} className="bg-white border m-2 rounded-2xl mb-7 overflow-hidden">
              <div className="flex items-center p-4 px-5">
                ...
                <div className='flex justify-between w-full items-center pr-5'>
                  <div>
                    <p className="font-semibold textFlex text-xs">@{user?.username}</p>
                    <p className="font-semibold textFlexed text-xs">{user?.fullname}</p>
                  </div>
